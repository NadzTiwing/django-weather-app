...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=c67156c75995700478f934a32d1853d6'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyDgwoAABoGxsyP8abg_Gl1VK_qGy1LCOWU'

    SEARCH_ENGINE_ID = '157e13e087cb840b6'
